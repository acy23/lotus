...
<head>
    ...
    <title>Medilax - Medical and Health Care HTML Template - Gallery</title>
                ...
                <div class="col-md-6 col-lg-4 filter-item cat-2 cat-3">
                    <div class="vs-project-box mb-30">
                        ...
                        <div class="project-content">
                            <span class="project-cat fs-xs">Development</span>
                            <h4 class="project-name">Heart Surgery</h4>
                            <a href="assets/img/project/pro-1-5.jpg" class="icon-btn style4 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 filter-item cat-2">
                    <div class="vs-project-box mb-30">
                        ...
                        <div class="project-content">
                            ...
                            <a href="assets/img/project/pro-1-6.jpg" class="icon-btn style4 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 filter-item cat-1 cat-2">
                    <div class="vs-project-box mb-30">
                        ...
                        <div class="project-content">
                            ...
                            <a href="assets/img/project/pro-1-7.jpg" class="icon-btn style4 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 filter-item cat-3">
                    <div class="vs-project-box mb-30">
                        ...
                        <div class="project-content">
                            ...
                            <a href="assets/img/project/pro-1-8.jpg" class="icon-btn style4 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 filter-item cat-1">
                    <div class="vs-project-box mb-30">
                        ...
                        <div class="project-content">
                            ...
                            <a href="assets/img/project/pro-1-9.jpg" class="icon-btn style4 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
