...
<head>
    ...
    <title>Medilax - Medical and Health Care HTML Template - Home Three</title>
                                ...
                                <div class="row  justify-content-xl-between justify-content-xxl-end align-items-center">
                                    ...
                                    <div class="col-auto d-none d-xl-block">
                                        <div class="header-btn">
                                            ...
                                            <a href="#" class="icon-btn has-badge d-none d-xxl-inline-block sideMenuToggler"><i class="far fa-shopping-cart"></i><span class="badge">3</span></a>
            ...
            <div class="row  text-center justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="section-title">
                        ...
                        <p>Proactively revolutionize granular customer service after pandemic internal or "organic"<span class="bg-theme text-white"> sources proactive human </span> capital rather.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row  text-center justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-6 wow fadeIn" data-wow-delay="0.3s">
                    <div class="section-title">
                        ...
                        <p class="text-white">Proactively revolutionize granular customer service after pandemic internal or "organic"<span class="bg-theme text-white"> sources proactive human </span> capital rather.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-4">
                    <div class="vs-project-box mb-30">
                        ...
                        <div class="project-content">
                            ...
                            <a href="assets/img/project/pro-1-1.jpg" class="icon-btn style4 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="vs-project-box mb-30">
                        ...
                        <div class="project-content">
                            ...
                            <a href="assets/img/project/pro-1-2.jpg" class="icon-btn style4 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="vs-project-box mb-30">
                        ...
                        <div class="project-content">
                            ...
                            <a href="assets/img/project/pro-1-3.jpg" class="icon-btn style4 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="vs-project-box mb-30">
                        ...
                        <div class="project-content">
                            ...
                            <a href="assets/img/project/pro-1-4.jpg" class="icon-btn style4 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xl-6">
                        <div class="vs-middle-box d-md-flex text-center text-md-start bg-title">
                            ...
                            <div class="media-body align-self-center">
                                <span class="text-theme fs-xs">Health Services</span>
                                <h4 class="text-title mb-0 text-white">Known the truth for Peace of Mind</h4>
                            </div>
                        </div>
                    </div>
                </div>
