...
<head>
    ...
    <title>Medilax - Medical and Health Care HTML Template - Services</title>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.html">Haematology</a></h3>
                            <p class="sr-text">Appropriately customize excellent imperatives for mission-critical products. </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.html">Family Physician</a></h3>
                            <p class="sr-text">Appropriately customize excellent imperatives for mission-critical products. </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.html">Pediatrician</a></h3>
                            <p class="sr-text">Appropriately customize excellent imperatives for mission-critical products. </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.html">Gynecologist</a></h3>
                            <p class="sr-text">Appropriately customize excellent imperatives for mission-critical products. </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.html">Expert Surgeon</a></h3>
                            <p class="sr-text">Appropriately customize excellent imperatives for mission-critical products. </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.html">Nephrologist</a></h3>
                            <p class="sr-text">Appropriately customize excellent imperatives for mission-critical products. </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-center justify-content-xl-start">
                            <div class="col-md-10 col-lg-7 col-xl-9 mb-4">
                                <div class="features-about text-center text-xl-start">
                                    ...
                                    <p>Proactively revolutionize granular customer service after pandemic internal or "organic" sources impact proactive human</p>
                                </div>
                            </div>
                            <div class="col-lg-9 col-xl-11 col-xxl-12">
                                <div class="row justify-content-center justify-content-xl-start">
                                    <div class="col-sm-6 col-xxl-auto mb-30">
                                        <div class="feaures-mark text-center text-md-start">
                                            ...
                                            <h3 class="mark-title h6 mb-1 ">Friendly Environment</h3>
                                    ...
                                    <div class="col-sm-6 col-xxl-auto mb-30">
                                        <div class="feaures-mark text-center text-md-start">
                                            <span class="mark-icon"><i class="far fa-check"></i></span>
                                            <h3 class="mark-title h6 mb-1 ">Specialist Surgery</h3>
                                            <p class="mark-text fs-xs mb-0">Isintermediate est of resources box</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xxl-auto mb-30">
                                        <div class="feaures-mark text-center text-md-start">
                                            <span class="mark-icon"><i class="far fa-check"></i></span>
                                            <h3 class="mark-title h6 mb-1 ">100% Safe & Trused</h3>
                                            <p class="mark-text fs-xs mb-0">Isintermediate est of resources box</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xxl-auto mb-30">
                                        <div class="feaures-mark text-center text-md-start">
                                            <span class="mark-icon"><i class="far fa-check"></i></span>
                                            <h3 class="mark-title h6 mb-1 ">24/7 take care staff</h3>
                                            <p class="mark-text fs-xs mb-0">Isintermediate est of resources box</p>
                                        </div>
                                    </div>
                                </div>
