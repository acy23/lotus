...
<head>
    ...
    <title>Medilax - Medical and Health Care HTML Template - News Details</title>
    ...
    <div class="breadcumb-wrapper ">
        ...
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Conveniently target robustes opportunities integrated...</h1>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="vs-blog blog-single">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                ...
                                <a href="#"><i class="fal fa-eye"></i>22 June, 2020</a>
                            </div>
                    ...
                    <div class="blog-author bg-smoke d-md-flex  ">
                        <div class="media-image mb-3 mb-md-0 mr-30 align-self-center">
                            <img src="assets/img/blog/blog-author.png" alt="Blog Author Image">
                        </div>
                        <div class="media-body">
                            <p class="author-degi text-theme mb-0">Written by</p>
                            <h3 class="author-name"><a class="text-reset" href="#">Jasmine Yulk</a></h3>
                                    ...
                                    <li class="vs-comment">
                                        <div class="vs-post-comment">
                                            ...
                                            <div class="comment-content">
                                                ...
                                                <span class="commented-on">23 April, 2020</span>
                    ...
                    <div class="vs-comment-form  ">
                        <div class="form-title">
                            ...
                            <p class="text-theme mb-4">Your email address will not be published. Required fields are marked *</p>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12 form-group mb-0">
                                <button class="vs-btn style2">Submit Message<i class="fas fa-chevron-right"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="recent-post-wrap">
                                ...
                                <div class="thumb-post">
                                    ...
                                    <div class="media-body ">
                                        ...
                                        <a class="post-date" href="blog.html"><i class="fal fa-calendar-alt"></i>Mar 21, 2021</a>
                                    </div>
                                </div>
